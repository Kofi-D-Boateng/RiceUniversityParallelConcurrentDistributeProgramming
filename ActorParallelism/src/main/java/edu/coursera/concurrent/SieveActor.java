...
public final class SieveActor extends Sieve {
    ...
    public int countPrimes(final int limit) {
        ...
        int numPrimes = 0;
        SieveActorActor looper = sieveActor;
        while(looper != null){
            numPrimes+= looper.getNumLocalPrimes();
            looper = looper.getNextActor();
        }
    ...
    public static final class SieveActorActor extends Actor {
        ...
        public int getNumLocalPrimes() {return numLocalPrimes;}
        ...
        private boolean isLocallyPrime(int candidate) {
            return checkPrimeKernel(candidate, numLocalPrimes);
        }

        private boolean checkPrimeKernel(int candidate, int end) {
            for(int i = 0; i < end; i++){
